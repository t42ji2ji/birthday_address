    ...
    <div id="app" class="remodal-bg render">
                ...
                <div class="text-center" style="color: white">
                    {{
                        running
                            ...
                            : '請填寫以下資訊，讓我們能夠在區塊鏈的茫茫宇宙中找到你的專屬錢包'
                    }}
                </div>
            </div>
        </div>
        ...
        <div v-if="!running" class="container" id="content" style="color: #a2a2a2; cursor: pointer">
            ...
            <div v-if="showTerms" style="color: #a2a2a2; margin-top: 1rem">
                - 親愛的使用者，<br />
                歡迎你參加我們的活動並體驗靈魂錢包的魅力！在這裡，我們將為你生成一個獨一無二的錢包地址與私鑰，這是你在區塊鏈宇宙通行的重要門票。但在此，我們也想提醒你幾個關鍵的事項：<br />
                1.
                私鑰保管：你對保護和使用你的私鑰擁有絕對的權利與義務。一旦遺失或洩露，可能會導致資產不可挽回的損失。<br />
                2.
                免責條款：本活動及其主辦方不會存儲你的私鑰，也無法幫助你恢復遺失的私鑰。因此，我們對於任何因私鑰遺失或不當使用而導致的損失或問題概不負責。<br />
                3.
                安全建議：我們強烈建議你在活動結束後立即將私鑰轉移到你個人安全的儲存空間，並遵循最佳安全實踐，KryptoGo
                錢包是一個好選擇。 謝謝你的理解與合作，讓我們共同努力維護一個安全又有趣的資產環境！<br />
                <br /><br />
            </div>
        </div>
    </div>
